...
export const metadata: Metadata = {
  title: 'Terms & Conditions — Bakeanaut',
  description:
    'Terms and conditions for using the Bakeanaut website and services. Read our full legal agreement.',
}
...
export default function TermsPage() {
  return (
    <LegalPage title="Terms & Conditions">
      <h2>General Terms</h2>
      <p>
        By accessing and placing an order with Bakeanaut, you confirm that you
      ...
      <p>
        Under no circumstances shall Bakeanaut team be liable for any direct,
        ...
        inability to use, the materials on this site, even if Bakeanaut team or
      ...
      <p>
        Bakeanaut will not be responsible for any outcome that may occur during
      ...
      <h2>License</h2>
      <p>
        Bakeanaut grants you a revocable, non-exclusive, non-transferable,
        limited license to download, install and use the website strictly in
        accordance with the terms of this Agreement.
      </p>
      <p>
        These Terms &amp; Conditions are a contract between you and Bakeanaut
        (referred to in these Terms &amp; Conditions as &quot;Bakeanaut&quot;,
        &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the provider of the
        Bakeanaut website and the services accessible from the Bakeanaut website
        (which are collectively referred to in these Terms &amp; Conditions as
        the &quot;Bakeanaut Service&quot;).
      </p>
      <p>
        ...
        Bakeanaut Service. In these Terms &amp; Conditions, &quot;you&quot;
      ...
      <ul>
        ...
        <li>
          ...
          Bakeanaut, that is responsible for your information under this Terms
          &amp; Conditions.
        </li>
        <li>
          <strong>Country:</strong> where Bakeanaut or the owners/founders of
          Bakeanaut are based, in this case is India.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of Bakeanaut or its affiliates, partners,
      ...
      <p>
        Thanks for shopping at Bakeanaut. We appreciate the fact that you like
      ...
      <p>
        ...
        apply to transactions at Bakeanaut. We&apos;ll be as brief as our
        attorneys will allow. The main thing to remember is that by placing an
        order or making a purchase at Bakeanaut, you agree to the terms along
        with Bakeanaut&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, &quot;Suggestions&quot;) provided by you to Bakeanaut
        with respect to the website shall remain the sole and exclusive property
        of Bakeanaut.
      </p>
      <p>
        Bakeanaut shall be free to use, copy, modify, publish, or redistribute
      ...
      <p>
        ...
        Bakeanaut. We are not responsible for the content, accuracy or opinions
      ...
      <h2>Cookies</h2>
      <p>
        Bakeanaut uses &quot;Cookies&quot; to identify the areas of our website
        ...
        login details every time you visit the website as we would not be able to
      ...
      <p>
        You acknowledge and agree that Bakeanaut may stop (permanently or
        temporarily) providing the Service (or any features within the Service)
        to you or to users generally at Bakeanaut&apos;s sole discretion,
        without prior notice to you. You may stop using the Service at any time.
        You do not need to specifically inform Bakeanaut when you stop using the
        Service. You acknowledge and agree that if Bakeanaut disables access to
      ...
      <p>
        Bakeanaut reserves the right to modify, suspend or discontinue,
      ...
      <p>
        Bakeanaut may from time to time provide enhancements or improvements to
      ...
      <p>
        ...
        the website. You agree that Bakeanaut has no obligation to (i) provide
      ...
      <p>
        You acknowledge and agree that Bakeanaut shall not be responsible for any
        Third-Party Services, including their accuracy, completeness,
        timeliness, validity, copyright compliance, legality, decency, quality or
        any other aspect thereof. Bakeanaut does not assume and shall not have
      ...
      <p>
        Bakeanaut may, in its sole discretion, at any time and for any or no
      ...
      <p>
        ...
        Bakeanaut, in the event that you fail to comply with any provision of
      ...
      <p>
        Termination of this Agreement will not limit any of Bakeanaut&apos;s
      ...
      <p>
        ...
        copyright owners; and (e) a statement that the information in the
      ...
      <p>
        You agree to indemnify and hold Bakeanaut and its parents, subsidiaries,
      ...
      <p>
        ...
        kind. To the maximum extent permitted under applicable law, Bakeanaut, on
        ...
        limitation to the foregoing, Bakeanaut provides no warranty or
      ...
      <p>
        Without limiting the foregoing, neither Bakeanaut nor any of
        Bakeanaut&apos;s providers makes any representation or warranty of any
        ...
        thereon; (ii) that the website will be uninterrupted or error-free; (iii)
        ...
        servers, the content, or e-mails sent from or on behalf of Bakeanaut are
      ...
      <p>
        ...
        Bakeanaut and any of its suppliers under any provision of this Agreement
      ...
      <p>
        ...
        Bakeanaut or its suppliers be liable for any special, incidental,
        ...
        the website, third-party software and/or third-party hardware used with
        the website, or otherwise in connection with any provision of this
        Agreement), even if Bakeanaut or any supplier has been advised of the
      ...
      <p>
        ...
        notices published by Bakeanaut on the Services, shall constitute the
        entire agreement between you and Bakeanaut concerning the Services. If
        ...
        term, and Bakeanaut&apos;s failure to assert any right or provision under
        this Agreement shall not constitute a waiver of such right or provision.
        YOU AND BAKEANAUT AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR
      ...
      <p>
        Bakeanaut reserves the right, at its sole discretion, to modify or
      ...
      <p>
        ...
        agree to the new terms, you are no longer authorized to use Bakeanaut.
      </p>

      <h2>Entire Agreement</h2>
      <p>
        The Agreement constitutes the entire agreement between you and Bakeanaut
        regarding your use of the website and supersedes all prior and
        contemporaneous written or oral agreements between you and Bakeanaut.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when you
        use or purchase other Bakeanaut services, which Bakeanaut will provide to
      ...
      <p>
        ...
        thereof), are owned by Bakeanaut, its licensors or other providers of
        such material and are protected by India and international copyright,
        ...
        without the express prior written permission of Bakeanaut, unless and
      ...
      <p>
        ...
        THE ENFORCEMENT OR VALIDITY OF YOUR OR BAKEANAUT&apos;S INTELLECTUAL
        PROPERTY RIGHTS. The term &quot;dispute&quot; means any dispute, action,
        or other controversy between you and Bakeanaut concerning the Services or
      ...
      <p>
        In the event of a dispute, you or Bakeanaut must give the other a Notice
        ...
        Notice of Dispute via email to: bakeanaut@gmail.com. Bakeanaut will send
        any Notice of Dispute to you by mail to your address if we have it, or
        otherwise to your email address. You and Bakeanaut will attempt to
        resolve any dispute through informal negotiation within sixty (60) days
        from the date the Notice of Dispute is sent. After sixty (60) days, you
        or Bakeanaut may commence arbitration.
      </p>

      <h2>Binding Arbitration</h2>
      <p>
        If you and Bakeanaut don&apos;t resolve any dispute by informal
      ...
      <p>
        ...
        will become the sole property of Bakeanaut without any compensation or
        credit to you whatsoever. Bakeanaut and its affiliates shall have no
      ...
      <h2>Promotions</h2>
      <p>
        Bakeanaut may, from time to time, include contests, promotions,
      ...
      <p>
        ...
        for the purchase and your order is canceled, we shall immediately issue a
      ...
      <p>
        ...
        effect. Any waiver of any provision of these Terms &amp; Conditions will
        be effective only if in writing and signed by an authorized
        representative of Bakeanaut. Bakeanaut will be entitled to injunctive or
        ...
        Bakeanaut operates and controls the Bakeanaut Service from its offices in
        ...
        or use would be contrary to law or regulation. Accordingly, those persons
        who choose to access the Bakeanaut Service from other locations do so on
        ...
        Conditions (which include and incorporate the Bakeanaut Privacy Policy)
        contains the entire understanding, and supersedes all prior
        understandings, between you and Bakeanaut concerning its subject matter,
      ...
      <h2>Disclaimer</h2>
      <p>
        Bakeanaut is not responsible for any content, code or any other
        imprecision.
      </p>
    </LegalPage>
  )
