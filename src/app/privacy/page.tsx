...
export const metadata: Metadata = {
  title: 'Privacy Policy — Bakeanaut',
  description:
    'Privacy policy for the Bakeanaut website. Learn how we collect, use, and protect your personal information.',
}
...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy">
      <p>
        Bakeanaut is committed to protecting your privacy. This Privacy Policy
      ...
      <p>
        ...
        Bakeanaut. By accessing or using our Service, you signify that you have
      ...
      <ul>
        ...
        <li>
          ...
          Bakeanaut, that is responsible for your information under this Privacy
          Policy.
        </li>
        <li>
        ...
        <li>
          ...
          employed by Bakeanaut or are under contract to perform a service on
      ...
      <h2>When Does Bakeanaut Use End User Information from Third Parties?</h2>
      <p>
        Bakeanaut will collect End User Data necessary to provide the Bakeanaut
      ...
      <h2>When Does Bakeanaut Use Customer Information from Third Parties?</h2>
      <p>
        ...
        becoming a Bakeanaut customer, we receive information from a third party
        that provides automated fraud detection services to Bakeanaut. We also
        ...
        social media websites make public by visiting these websites and changing
      ...
      <p>
        ...
        whose products or services we think may interest you. We may also share
        it with our current and future affiliated companies and business
      ...
      <p>
        Bakeanaut will collect personal information that you submit to us. We may
      ...
      <p>
        We keep your information only so long as we need it to provide Bakeanaut
      ...
      <p>
        ...
        Socket Layer (SSL) technology and then encrypted into our Payment gateway
        ...
        cards, social security numbers, financials, etc.) is never kept on file.
        We cannot, however, ensure or warrant the absolute security of any
        information you transmit to Bakeanaut or guarantee that your information
      ...
      <p>
        Bakeanaut is incorporated in India. Information collected via our
        ...
        have laws of general applicability regulating the use and transfer of
        such data. To the fullest extent allowed by applicable law, by using any
        of the above, you voluntarily consent to the trans-border transfer and
        hosting of such information.
      </p>

      <h2>
        Is the Information Collected Through the Bakeanaut Service Secure?
      </h2>
      <p>
      ...
      <p>
        ...
        Bakeanaut collects depend on your relationship with Bakeanaut. Personnel
      ...
      <p>
        ...
        each and every record of the information you have provided to us from our
      ...
      <p>
        ...
        the assets of Bakeanaut or any of its Corporate Affiliates (as defined
        herein), or that portion of Bakeanaut or any of its Corporate Affiliates
      ...
      <p>
        ...
        &quot;Corporate Affiliate&quot; means any person or entity which directly
        or indirectly controls, is controlled by or is under common control with
        Bakeanaut, whether by ownership or otherwise. Any information relating to
      ...
      <p>
        ...
        of the courts in connection with any action or dispute arising between
        the parties under or in connection with this Privacy Policy except for
        those individuals who may have rights to make claims under Privacy
      ...
      <p>
        By using Bakeanaut or contacting us directly, you signify your
      ...
      <p>
        ...
        contain links to other websites not operated or controlled by Bakeanaut.
        ...
        use a link to go from the Services to another website, our Privacy Policy
        is no longer in effect. Your browsing and interaction on any other
        website, including those that have a link on our platform, is subject to
      ...
      <p>
        ...
        cookies and similar technologies, but this action may block our essential
        cookies and prevent our website from functioning properly, and you may
        not be able to fully utilize all of its features and services. You should
      ...
      <p>
        ...
        your device when you use the service. Facebook pixel collects information
      ...
      <p>
        ...
        thing to do. At Bakeanaut we strongly believe that your data privacy is
      ...
      <p>
        ...
        requirements of GDPR. Bakeanaut processes or stores all personal data in
      ...
      <p>
        ...
        remove personal data. We&apos;ve been set up as self service from the
        start and have always given you access to your data and your
      ...
      <ul>
        ...
        <li>
          <strong>Right to Delete.</strong> You may submit a verifiable request
          to close your account and we will delete Personal Information about you
